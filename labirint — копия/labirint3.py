...
w2 = GameSprite('platform2.png', 370, 100, 50, 500)
w3 = GameSprite('platform1.png',550, 100, 300, 50) 

barriers.add(w1) 
barriers.add(w2) 
barriers.add(w3)

packman = Player('am.png', 5, 420, 80, 80, 0, 0)

monster = Enemy('k.png', win_width - 80, 180, 80, 80, 5) 
final_sprite = GameSprite('ta.png', win_width - 85, win_height - 100, 80, 80) 
